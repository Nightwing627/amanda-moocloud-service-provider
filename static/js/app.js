...
const PlansComponent = () => {
  ...
  const fetchProductsInfo = async () => {
    const data = await $.getJSON("https://beta.78.47.232.171.easymanager.ch/managed-nvme-hosting/products.info.json");
  ...
  const NavigationButton = ({ direction }) => {
    ...
    return (
      <h1>ssdsd</h1>
      // <div
      //   className="btn btn-light navigation-button d-none d-sm-inline-block"
      //   onClick={func}
      // >
